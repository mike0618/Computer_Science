...
public: // program scope members
  ...
  // setter
  void set_len(double len) { m_len = len; }
...
int main() {
  ...
  // use getter to retrieve the original length
  std::cout << "Original length of Spaceship2: " << spaceship2.get_len()
            << std::endl;
  // use setter to assign a new length value
  spaceship2.set_len(204.5);
  // disp the new value
  std::cout << "New length of Spaceship2: " << spaceship2.get_len()
            << std::endl;
